        ...
        <html>
            ...
            <body>
                ...
                <xsl:for-each select="tvshow/show">
                    ...
                    <p>The show <xsl:value-of select="name" /> was released in <xsl:value-of select="release" /> by <xsl:value-of
                            select="network" />. It had an average viewship of <xsl:value-of select="viewers" /> million people.
                        It was canceled in <xsl:value-of select="end_date" />.
                    </p>
