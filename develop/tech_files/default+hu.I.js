(function() {
var _UDS_CONST_LOCALE = 'hu';
var _UDS_CONST_SHORT_DATE_PATTERN = 'YMD';
var _UDS_MSG_SEARCHER_IMAGE = ('K\u00e9p');
var _UDS_MSG_SEARCHER_WEB = ('Web');
var _UDS_MSG_SEARCHER_BLOG = ('Blog');
var _UDS_MSG_SEARCHER_VIDEO = ('Vide\u00f3');
var _UDS_MSG_SEARCHER_LOCAL = ('Helyi');
var _UDS_MSG_SEARCHCONTROL_SAVE = ('ment\u00e9s');
var _UDS_MSG_SEARCHCONTROL_KEEP = ('megtart');
var _UDS_MSG_SEARCHCONTROL_INCLUDE = ('belevesz');
var _UDS_MSG_SEARCHCONTROL_COPY = ('m\u00e1sol\u00e1s');
var _UDS_MSG_SEARCHCONTROL_CLOSE = ('bez\u00e1r');
var _UDS_MSG_SEARCHCONTROL_SPONSORED_LINKS = ('Fizetett Hivatkoz\u00e1sok');
var _UDS_MSG_SEARCHCONTROL_SEE_MORE = ('t\u00f6bb...');
var _UDS_MSG_SEARCHCONTROL_WATERMARK = ('kiv\u00e1lasztva');
var _UDS_MSG_SEARCHER_CONFIG_SET_LOCATION = ('Keres\u00e9si hely');
var _UDS_MSG_SEARCHER_CONFIG_DISABLE_ADDRESS_LOOKUP = ('Helymeghat\u00e1roz\u00e1s kikapcsol\u00e1sa');
var _UDS_MSG_SEARCHER_NEWS = ('H\u00edrek');
function _UDS_MSG_MINUTES_AGO(AGE_MINUTES_AGO) {return ('' + AGE_MINUTES_AGO + ' perce');}
var _UDS_MSG_ONE_HOUR_AGO = ('1 \u00f3r\u00e1ja');
function _UDS_MSG_HOURS_AGO(AGE_HOURS_AGO) {return ('' + AGE_HOURS_AGO + ' \u00f3r\u00e1ja');}
function _UDS_MSG_NEWS_ALL_N_RELATED(NUMBER) {return ('' + NUMBER + ' kapcsol\u00f3d\u00f3 anyag');}
var _UDS_MSG_NEWS_RELATED = ('Kapcsol\u00f3d\u00f3 anyagok');
var _UDS_MSG_BRANDING_STRING = ('\u00dczemeltet\u0151: Google');
var _UDS_MSG_SORT_BY_DATE = ('Rendez\u00e9s d\u00e1tum szerint');
var _UDS_MSG_MONTH_ABBR_JAN = ('jan.');
var _UDS_MSG_MONTH_ABBR_FEB = ('febr.');
var _UDS_MSG_MONTH_ABBR_MAR = ('m\u00e1rc.');
var _UDS_MSG_MONTH_ABBR_APR = ('\u00e1pr.');
var _UDS_MSG_MONTH_ABBR_MAY = ('m\u00e1j.');
var _UDS_MSG_MONTH_ABBR_JUN = ('j\u00fan.');
var _UDS_MSG_MONTH_ABBR_JUL = ('j\u00fal.');
var _UDS_MSG_MONTH_ABBR_AUG = ('aug.');
var _UDS_MSG_MONTH_ABBR_SEP = ('szept.');
var _UDS_MSG_MONTH_ABBR_OCT = ('okt.');
var _UDS_MSG_MONTH_ABBR_NOV = ('Nov.');
var _UDS_MSG_MONTH_ABBR_DEC = ('Dec.');
var _UDS_MSG_DIRECTIONS = ('utas\u00edt\u00e1sok');
var _UDS_MSG_CLEAR_RESULTS = ('eredm\u00e9nyek t\u00f6rl\u00e9se');
var _UDS_MSG_SHOW_ONE_RESULT = ('egy eredm\u00e9ny mutat\u00e1sa');
var _UDS_MSG_SHOW_MORE_RESULTS = ('t\u00f6bb eredm\u00e9ny mutat\u00e1sa');
var _UDS_MSG_SHOW_ALL_RESULTS = ('\u00f6sszes eredm\u00e9ny mutat\u00e1sa');
var _UDS_MSG_SETTINGS = ('be\u00e1ll\u00edt\u00e1sok');
var _UDS_MSG_SEARCH = ('keres\u00e9s');
var _UDS_MSG_SEARCH_UC = ('Keres\u00e9s');
var _UDS_MSG_POWERED_BY = ('\u00dczemeltet\u0151:');
function _UDS_MSG_LOCAL_ATTRIBUTION(LOCAL_RESULTS_PROVIDER) {return ('\u00dczleti list\u00e1k - a(z) ' + LOCAL_RESULTS_PROVIDER + ' \u00e1ltal');}
var _UDS_MSG_SEARCHER_BOOK = ('K\u00f6nyv');
function _UDS_MSG_FOUND_ON_PAGE(FOUND_ON_PAGE) {return ('' + FOUND_ON_PAGE + '. oldal');}
function _UDS_MSG_TOTAL_PAGE_COUNT(PAGE_COUNT) {return ('' + PAGE_COUNT + ' oldal');}
var _UDS_MSG_SEARCHER_BY = ('szerz\u0151:');
var _UDS_MSG_SEARCHER_CODE = ('K\u00f3d');
var _UDS_MSG_UNKNOWN_LICENSE = ('Ismeretlen licenc');
var _UDS_MSG_SEARCHER_GSA = ('Keres\u0151 alkalmaz\u00e1s');
var _UDS_MSG_SEARCHCONTROL_MORERESULTS = ('Tov\u00e1bbi eredm\u00e9nyek');
var _UDS_MSG_SEARCHCONTROL_PREVIOUS = ('El\u0151z\u0151');
var _UDS_MSG_SEARCHCONTROL_NEXT = ('K\u00f6vetkez\u0151');
var _UDS_MSG_GET_DIRECTIONS = ('\u00datvonal');
var _UDS_MSG_GET_DIRECTIONS_TO_HERE = ('Ide');
var _UDS_MSG_GET_DIRECTIONS_FROM_HERE = ('Innen');
var _UDS_MSG_CLEAR_RESULTS_UC = ('Eredm\u00e9nyek t\u00f6rl\u00e9se');
var _UDS_MSG_SEARCH_THE_MAP = ('keres\u00e9s a t\u00e9rk\u00e9pen');
var _UDS_MSG_SCROLL_THROUGH_RESULTS = ('eredm\u00e9nyek g\u00f6rget\u00e9se');
var _UDS_MSG_EDIT_TAGS = ('c\u00edmk\u00e9k szerkeszt\u00e9se');
var _UDS_MSG_TAG_THIS_SEARCH = ('a keres\u00e9s felc\u00edmk\u00e9z\u00e9se');
var _UDS_MSG_SEARCH_STRING = ('keres\u00e9s\u00e9si kifejez\u00e9s');
var _UDS_MSG_OPTIONAL_LABEL = ('opcion\u00e1lis c\u00edmke');
var _UDS_MSG_DELETE = ('t\u00f6rl\u00e9s');
var _UDS_MSG_DELETED = ('t\u00f6r\u00f6lve');
var _UDS_MSG_CANCEL = ('m\u00e9gse');
var _UDS_MSG_UPLOAD_YOUR_VIDEOS = ('saj\u00e1t vide\u00f3 felt\u00f6lt\u00e9se');
var _UDS_MSG_IM_DONE_WATCHING = ('V\u00e9geztem a megn\u00e9z\u00e9s\u00e9vel');
var _UDS_MSG_CLOSE_VIDEO_PLAYER = ('vide\u00f3lej\u00e1tsz\u00f3 bez\u00e1r\u00e1sa');
var _UDS_MSG_NO_RESULTS = ('Nincs tal\u00e1lat');
var _UDS_MSG_LINKEDCSE_ERROR_RESULTS = ('A Google egy\u00e9ni keres\u0151motor bet\u00f6lt\u00e9se folyamatban. Pr\u00f3b\u00e1lkozzon \u00fajra n\u00e9h\u00e1ny m\u00e1sodpercen bel\u00fcl.');
var _UDS_MSG_COUPONS = ('Utalv\u00e1nyok');
var _UDS_MSG_BACK = ('vissza');
var _UDS_MSG_SUBSCRIBE = ('Regisztr\u00e1ci\u00f3');
var _UDS_MSG_SEARCHER_PATENT = ('Szabadalom');
var _UDS_MSG_USPAT = ('USA szabadalom');
var _UDS_MSG_USPAT_APP = ('US Pat. App');
var _UDS_MSG_PATENT_FILED = ('T\u00e1rolva');
var _UDS_MSG_ADS_BY_GOOGLE = ('Google Hirdet\u00e9sek');
var _UDS_MSG_SET_DEFAULT_LOCATION = ('Alap\u00e9rtelmezett helyzet be\u00e1ll\u00edt\u00e1sa');
var _UDS_MSG_NEWSCAT_TOPSTORIES = ('F\u0151 h\u00edrek');
var _UDS_MSG_NEWSCAT_WORLD = ('Nemzetk\u00f6zi');
var _UDS_MSG_NEWSCAT_NATION = ('Belf\u00f6ldi h\u00edrek');
var _UDS_MSG_NEWSCAT_BUSINESS = ('Gazdas\u00e1g/\u00fczleti \u00e9let');
var _UDS_MSG_NEWSCAT_SCITECH = ('Tudom\u00e1ny/technol\u00f3gia');
var _UDS_MSG_NEWSCAT_ENTERTAINMENT = ('Kult\u00fara/sz\u00f3rakoz\u00e1s');
var _UDS_MSG_NEWSCAT_HEALTH = ('Eg\u00e9szs\u00e9g\u00fcgy');
var _UDS_MSG_NEWSCAT_SPORTS = ('Sport');
var _UDS_MSG_NEWSCAT_POLITICS = ('Politika');
var _UDS_MSG_SEARCH_RESULTS = ('Keres\u00e9s tal\u00e1latok');
var _UDS_MSG_DID_YOU_MEAN = ('Keres\u00e9si javaslat:');
var _UDS_MSG_CUSTOM_SEARCH = ('Egy\u00e9ni Keres\u0151');
var _UDS_MSG_LABELED = ('Megc\u00edmk\u00e9zett');
var _UDS_MSG_LOADING = ('Bet\u00f6lt\u00e9s...');
var _UDS_MSG_ALL_RESULTS_SHORT = ('\u00d6sszes');
var _UDS_MSG_ALL_RESULTS_LONG = ('\u00d6sszes tal\u00e1lat');
var _UDS_MSG_REFINE_RESULTS = ('Tal\u00e1latok finom\u00edt\u00e1sa:');
function _UDS_MSG_REVIEWS(REVIEW_COUNT) {return ('' + REVIEW_COUNT + ' v\u00e9lem\u00e9ny');}
function _UDS_MSG_CALORIES(CALORIES) {return ('' + CALORIES + ' cal');}
function _UDS_MSG_PRICE_RANGE(RANGE) {return ('\u00c1rtartom\u00e1ny: ' + RANGE + '.');}
function _UDS_MSG_PRICE(PRICE) {return ('\u00c1r: ' + PRICE + '.');}
function _UDS_MSG_AVAILABILITY(AVAILABILITY) {return ('El\u00e9rhet\u0151s\u00e9g: ' + AVAILABILITY + '.');}
function _UDS_MSG_TELEPHONE(TELEPHONE) {return ('Tel: ' + TELEPHONE);}
function _UDS_MSG_RESULT_INFO(NUMBER_OF_RESULTS, SEARCH_TIME) {return ('Nagyj\u00e1b\u00f3l ' + NUMBER_OF_RESULTS + ' tal\u00e1lat (' + SEARCH_TIME + ' m\u00e1sodperc)');}
var _UDS_MSG_FILE_FORMAT = ('F\u00e1jl form\u00e1tuma:');
var _UDS_MSG_SHOWING_RESULTS_FOR = ('Tal\u00e1latok a k\u00f6vetkez\u0151re:');
var _UDS_MSG_SEARCH_INSTEAD_FOR = ('Ink\u00e1bb erre szeretn\u00e9k r\u00e1keresni:');
function _UDS_MSG_FILTERED_RESULTS(NUM) {return ('Annak \u00e9rdek\u00e9ben, hogy a legink\u00e1bb relev\u00e1ns tal\u00e1latokat jelen\u00edts\u00fck meg \u00d6nnek, kihagytunk n\u00e9h\u00e1ny, a megjelen\u00edtett ' + NUM + ' tal\u00e1lathoz nagyon hasonl\u00f3 bejegyz\u00e9st. Ha k\u00edv\u00e1nja, ' + '<a>megism\u00e9telheti a keres\u00e9st a kihagyott tal\u00e1latok megjelen\u00edt\u00e9s\u00e9vel' + '</a>.');}
var _UDS_MSG_ORDER_BY = ('Rendez\u00e9s:');
var _UDS_MSG_ORDER_BY_RELEVANCE = ('Relevancia');
var _UDS_MSG_ORDER_BY_DATE = ('D\u00e1tum');
var _UDS_MSG_ORDER_BY_GET_LINK = ('Az oldal megoszt\u00e1sa:');
