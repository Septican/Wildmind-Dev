...
// Customized By Pete R.
// -------------------------------------------------------------------

var gfeedfetcher_loading_image="images/ajax-loading.gif" //Full URL to "loading" image. No need to config after this line!!
...
gfeedfetcher._formatdate=function(datestr, showoptions){
  ...
  month[11]="December";
	...
	var parseddate=(showoptions.indexOf("datetime")!=-1)? itemdate.toLocaleString() : (showoptions.indexOf("date")!=-1)? "<div class='day'>" + itemdate.getDate() + "</div>" + "<div class='month'>" + month[itemdate.getMonth()] + "</div>" + "<div class='year'>" + itemdate.getFullYear() + "</div>" : (showoptions.indexOf("time")!=-1)? itemdate.toLocaleTimeString() : ""
	return "<div class='datefield'>"+parseddate+"</div>"
}
...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	for (var i=0; i<feeds.length; i++){
		var itemtitle="<h3><a href=\"" + feeds[i].link + "\" target=\"" + this.linktarget + "\" class=\"titlefield\">" + feeds[i].title + "</a></h3>"
		...
		rssoutput+=this.itemcontainer + itemdate + "<div class='post-content'>"  + itemtitle  + itemlabel + itemdescription + "</div>" + this.itemcontainer.replace("<", "</") + "\n\n"
	}
